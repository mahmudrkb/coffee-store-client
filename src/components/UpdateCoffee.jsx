...
const UpdateCoffee = () => {
    ...
    const { name, _id, photo, taste,quantity,supplier,category,details } = coffee;
    ...
    return (
        ...
        <h2 className="text-5xl text-black text-center  font-bold ">Update  Coffee :{name}</h2>
      <form onSubmit={handleUpdateCoffee}>
        ...
        <div className="form-control w-1/2">
          ...
          <input type="text" defaultValue={quantity}  placeholder="Available" 
        ...
        <div className=" w-1/2">
          ...
          <input type="text" defaultValue={supplier}  placeholder="Supplier Name" 
        ...
        <div className="w-1/2 ">
          ...
          <input type="text" defaultValue={taste}  placeholder="Taste" 
        ...
        <div className=" w-1/2">
          ...
          <input type="text" defaultValue={category}  placeholder="Category" 
        ...
        <div className="w-1/2 ">
          ...
          <input type="text" defaultValue={details}  placeholder="Details" 
